...
/*
    this.$http.get('https://api4-datame.herokuapp.com/api/v3/reviews_companies',{ headers:
      { Authorization: token }
      }).then((result) => {
        this.reviews_c = result.data
      })

    this.$http.get('https://api4-datame.herokuapp.com/api/v3/reviews_datascientists',{ headers:
      { Authorization: token }
      }).then((result) => {
        this.reviews_d = result.data
      })
*/
    this.$http.get('https://api4-datame.herokuapp.com/api/v3/ranking_datascientists',{ headers:
      { Authorization: token }
      }).then((result) => {
    ...
    this.$http.get('https://api4-datame.herokuapp.com/api/v3/ranking_companies',{ headers:
      { Authorization: token }
      }).then((result) => {
