...
export default {
  ...
  mounted: function() {
    ...
    this.$http
      .get("https://api4-datame.herokuapp.com/api/v2/admin/offers", {
    ...
    this.$http
      .get("https://api4-datame.herokuapp.com/api/v1/users", {
        headers: { Authorization: token }
      })
      .then(result => {
    ...
    this.$http
      .get("https://api4-datame.herokuapp.com/api/v1/companies", {
        headers: { Authorization: token }
      })
      .then(result => {
    ...
    this.$http
      .get("https://api4-datame.herokuapp.com/api/v1/applications", {
        headers: { Authorization: token }
      })
      .then(result => {
    ...
    this.$http
      .get("https://api4-datame.herokuapp.com/api/v1/applicationsAccepted", {
        headers: { Authorization: token }
      })
      .then(result => {
    ...
    this.$http
      .get("https://api4-datame.herokuapp.com/api/v1/submitions", {
        headers: { Authorization: token }
      })
      .then(result => {
    ...
    this.$http
      .get("https://api4-datame.herokuapp.com/api/v1/messages", {
        headers: { Authorization: token }
      })
      .then(result => {
